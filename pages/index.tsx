...
const Home: NextPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#161A1E] relative">
      <Head>
        <title>Zustand Commerce Store</title>
      ...
      <main className='py-8 px-10 xl:px-16'>
        ...
        <div className="title flex justify-center">
          <h1 className="font-bold text-7xl xl:text-9xl text-center inline-block text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-blue-500">Zustand Store</h1>
        </div>
